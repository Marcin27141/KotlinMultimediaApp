...
class PrimaryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var dir1 = MediaStore.Images.Media.EXTERNAL_CONTENT_URI
        ...
        binding.directory1.text = dir1.path
...
//        dir4?.let {
//            val sth = BuildConfig.APPLICATION_ID
//            val uri = FileProvider.getUriForFile(requireContext(), "${BuildConfig.APPLICATION_ID}.provider", it)
//        }
